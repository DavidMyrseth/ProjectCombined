...
**Koostaja**: David Myrseth, 03.12.2025
...
|-----------------------------|-------------|------------|
| Virtuaalkeskkonna seadistus |David Myrseth| 5 min      |
| Serveri ja `/status` testid | David Myrseth | 2 min      |
| Koondandmete/kombineerimise test | David Myrseth | 2 min      |
| Veaolukordade katsetus      | David Myrseth | 10 min     |
...
| Töö                | Vastutaja   | Aeg    |
|--------------------|-------------|--------|
| Sündmuste kontroll |David Myrseth| 10 min |
| Võrgupaneeli ülevaatus |David Myrseth| 5 min  |
| Ekraanipiltide talletus |David Myrseth| 5 min  |
...
| Töö              | Vastutaja   | Aeg       |
|------------------|-------------|-----------|
| Testide loomine  |David Myrseth| 10-15 min |
| Testkäivitus/logi|David Myrseth| 5 min     |
...
|--------------------|-------------|----------|
| Testide kirjutamine|David Myrseth| 10-15 min|
| Testkäivitus/logi  |David Myrseth| 5 min    |
...
| Faas                 | Vastutaja   | Aeg    |
|----------------------|-------------|--------|
| Variandi ja HTML test| David Myrseth | 5-10 min |
| Nupu/sündmuse kontroll| David Myrseth | 5 min    |
| Logide talletus      | David Myrseth | 5 min    |
...
|-------------|--------------|------------|
| Testide loomine | David Myrseth | 10–15 min  |
| Testdev ja logi | David Myrseth | 5 min      |
...
|---------------------|-------------|----------|
| Workflow koostamine | David Myrseth | 5–10 min |
| Testide lisamine CI | David Myrseth | 5–10 min |
| Artefaktid/README raport | David Myrseth | 5 min    |
...
| Töö            | Vastutaja   | Kestus   |
|----------------|-------------|----------|
| Backend kontroll| David Myrseth| 2 min    |
| Koormustest    | David Myrseth| 8 min    |
| Piltide lisamine| David Myrseth| 5 min    |
